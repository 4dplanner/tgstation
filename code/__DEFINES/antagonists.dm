...
#define WEREBEAST_WARNING_TIME 150
#define WEREBEAST_URGENT_WARNING_TIME 180
#define WEREBEAST_TRANSFORMATION_COOLDOWN 100
#define WEREBEAST_FORCED_TRANSFORMATION_TIME 200
